...
\definecolor{codelightblue}{rgb}{0,0,0.5}
...
\newpage
%\lstinputlisting[language=Java,caption={A simple birdwatching application implemented in Cloud Types pseudo-language}]{birdwatching.txt}
