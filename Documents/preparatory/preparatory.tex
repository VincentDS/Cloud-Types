...
\begin{description}
    ...
    \item[display] \hfill \\To get an overview of all the spotted birds, the display function is used. But as previously mentioned, the \textcolor{codeblue}{Index} \textbf{BirdList} is a virtually infinite collection of all the existing birds. Because it is impossible to iterate over a infinite array, there to be a better solution.
\end{description}
